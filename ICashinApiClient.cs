...
namespace Basis.Service.Cashin.Client
{
    public interface ICashinApiClient
    {
        ...
        Task<TransactionStatusResponse> StatusCheckAsync(string trasactionId);
        ...
        Task<ClientResponse> CheckAsync(ClientCheckRequest request);
        ...
        Task<AccountsResponse> AccountsAsync(AccountRequest request);

        /// <summary>
        /// აბრუნებს ბანკის კურსებს
        /// </summary>
        /// <returns></returns>
        Task<CurrencyRatesResponse> CurrencyRatesAsync();
    }
}
